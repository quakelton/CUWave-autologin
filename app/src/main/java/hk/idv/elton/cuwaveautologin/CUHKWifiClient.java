...
// Client for CUHK WiFi system running on Aruba Networks
public class CUHKWifiClient implements LoginClient {

    private static final String TAG = "CUHKWifiClient";
    ...
    private static final String FORM_URL = "https://securelogin.wlan.cuhk.edu.hk/cgi-bin/login";
    private static final String LOGOUT_URL = "";

    private DefaultHttpClient mHttpClient;

    public CUHKWifiClient(Context context) throws IOException {
        mHttpClient = Utils.createHttpClient(true, new byte[][] {
                Utils.getRawResource(context, R.raw.cuhkwifi)
        });
    }
