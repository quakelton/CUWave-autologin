...
// Client for ERGWAVE WiFi system running on Aruba Networks
public class ERGWAVEClient implements LoginClient {

    private static final String TAG = "ERGWAVEClient";
    ...
    public ERGWAVEClient(Context context) throws IOException {
